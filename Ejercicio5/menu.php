      ...
      <nav class="navbar navbar-expand-lg bg-light sticky-top">
        <div class="container-fluid">
          <a class="navbar-brand" href="<?php echo $nivel; ?>home.php">
            ...
            <img src="<?php echo $nivel; ?>image/1.png" alt="" width="50px">
            <a style="color:red; font-size: 25px;">Facultad </a>
          <a style="color:blue; font-size: 25px;"> &nbsp;de </a>
          <a style="color:red; font-size: 25px;"> &nbsp;Ciencias Puras  </a>
          </a>
