      ...
      <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="./image/1-cr.jpg" alt="" width="100%">

            <div class="container">
              <div class="carousel-caption text-start">
                <h1 style="font-size:50px">INFORMÁTICA</h1>
                <p style="font-size:30px">
                Computadora Análisis y Semántica.... Adelante Informática....!!
                </p>
                <p>
                  <a class="btn btn-lg btn-primary" href="<?php echo $nivel;?>inf/index.php">Ingresar >>></a>
                </p>
              </div>
            </div>
          </div>
          <div class="carousel-item">
            <img src="./image/2-CR.jpg" alt="">

            <div class="container">
              <div class="carousel-caption text-start">
                <h1 style="font-size:50px">MATEMÁTICA.</h1>
                <p style="font-size:30px">
                Excelencia en la Formación Profesional
                </p>
                <p><a class="btn btn-lg btn-primary" href="<?php echo $nivel;?>mat/index.php">Ingresar >>></a></p>
              </div>
            </div>
          </div>
          <div class="carousel-item">
            <img src="./image/3-cr.jpg" alt="">
            <div class="container">
              <div class="carousel-caption text-start">
                <h1 style="font-size:50px">FÍSICA</h1>
                <p style="font-size:30px">
                Excelencia en la Formación Profesional
                </p>
                <p>
                  <a class="btn btn-lg btn-primary" href="<?php echo $nivel;?>fis/index.php">Ingresar >>></a>
                </p>
              </div>
            </div>
          </div>
  ...
  ================================================== -->
      ...
      <div class="container marketing">
        ...
        <div class="row featurette">
          ...
          <div class="col-md-5">
            <img src="./image/1.png" alt="" width="500px">
          </div>
        </div>
